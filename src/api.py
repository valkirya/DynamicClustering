...
def run_model (inputs, file_name = None):  
    ...
    for (key,value) in data_repartition.items():
        ...
        try:
            ...
            output_folder = PostProcessing.generate_output_folder (param.output_directory, param.svc_name, key)
            ...
            if param.plot :
                ...
                PostProcessing.write_cluster_map (cluster_map, param.svc_name, model.num_cluster, output_folder, key)
